...
<body class="antialiased text-gray-500" style="background-color: darkslategrey;">
    <header style="text-align: right; color:black; margin:2vh;" dir="rtl">
        @if (Route::has('login'))
            @auth
            <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 mx-1">
                <svg width="40" height="40" style="display: inline;" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                </svg>
            </a>
            @else
            <a href="{{ route('login') }}" class="mx-1">
                <svg width="40" height="40" style="display: inline;" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <main class="relative flex items-top justify-center bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0" style="min-height:80vh">

        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">

            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <h1 class="p-6">Note Manager</h1>
            </div>
            <div style="color:white">
                @auth
                    Goto your
                    <a href="{{ url('/dashboard') }}" style="text-decoration: underline;">Dashboard</a>
                    or use API
                @else
                    Please
                    <a href="{{ route('login') }}" style="text-decoration: underline;">Login</a>
                    or
                    <a href="{{ route('register') }}" style="text-decoration: underline;">register</a>.
                @endauth
            </div>
        </div>
    </main>
